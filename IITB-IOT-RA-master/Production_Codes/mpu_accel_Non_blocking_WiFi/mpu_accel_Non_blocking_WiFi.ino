...
IPAddress staticIP(192, 168, 0, 189);
...
void calibrate_MPU(float acc_bias[], float gyro_bias[]) {  //pass array by ref
  ...
  const int MPU9250_MINIMUM_SAMPLING_DELAY_uSEC = 125;  //125 because max sampling rate of accelerometer is 8 khz
