...
// #define chipSelect 35
byte chipSelect = 4; // Change to fit your project.
...
void setup()
{
  ...
  // SPI.begin();
  // kxSettings=SPISettings(1000000,MSBFIRST,SPI_MODE0); //SPISettings(uint32_t clock, uint8_t bitOrder, uint8_t dataMode)
